...
public class ProducerController {
	 ...
	 */
	@GetMapping("/sendDlx")
	public Object sendDlx(String routingKey,String message) throws AmqpException, UnsupportedEncodingException {
		...
		//fanout模式只往exchange里发送消息。分发到exchange下的所有queue
		rabbitTemplate.send("orderExchange", routingKey, new Message(message.getBytes("UTF-8"),messageProperties));
