...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL, '2021-06-12 12:42:48');
INSERT INTO `xxl_job_group` VALUES (2, 'xxl-job-springbootzjmdemo', '我的springboot', 1, 'http://127.0.0.1:9995/', '2021-06-06 22:10:59');
...
INSERT INTO `xxl_job_info` VALUES (2, 1, '我的例子', '2021-06-06 22:07:47', '2021-06-06 22:07:47', '张三', '', 'CRON', '0 * * * * ?', 'DO_NOTHING', 'FIRST', 'demoJobHandler_myself', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2021-06-06 22:07:47', '', 0, 0, 0);
INSERT INTO `xxl_job_info` VALUES (3, 2, '我的springboot执行任务', '2021-06-06 22:12:15', '2021-06-06 22:12:15', '李四', '', 'CRON', '* 0,1 * * * ?', 'DO_NOTHING', 'FIRST', 'springBootHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2021-06-06 22:12:15', '', 0, 0, 0);
...
-- ----------------------------
INSERT INTO `xxl_job_log` VALUES (1, 1, 2, 'http://127.0.0.1:9999/', 'demoJobHandler_myself', '', NULL, 0, '2021-06-06 22:07:53', 200, '任务触发类型：手动触发<br>调度机器：192.168.0.5<br>执行器-注册方式：自动注册<br>执行器-地址列表：[http://127.0.0.1:9999/]<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>触发调度：<br>address：http://127.0.0.1:9999/<br>code：200<br>msg：null', '2021-06-06 22:07:53', 200, '', 0);
INSERT INTO `xxl_job_log` VALUES (2, 2, 3, 'http://127.0.0.1:9995/', 'springBootHandler', '', NULL, 0, '2021-06-06 22:12:28', 200, '任务触发类型：手动触发<br>调度机器：192.168.0.5<br>执行器-注册方式：手动录入<br>执行器-地址列表：[http://127.0.0.1:9995/]<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>触发调度：<br>address：http://127.0.0.1:9995/<br>code：200<br>msg：null', '2021-06-06 22:12:28', 200, '', 0);
...
-- ----------------------------
INSERT INTO `xxl_job_log_report` VALUES (1, '2021-06-06 00:00:00', 0, 1, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (2, '2021-06-05 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (3, '2021-06-04 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (4, '2021-06-09 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (5, '2021-06-08 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (6, '2021-06-07 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (7, '2021-06-12 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (8, '2021-06-11 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (9, '2021-06-10 00:00:00', 0, 0, 0, NULL);
...
-- ----------------------------
INSERT INTO `xxl_job_registry` VALUES (8, 'EXECUTOR', 'xxl-job-springbootzjmdemo', 'http://127.0.0.1:9995/', '2021-06-12 12:43:06');
